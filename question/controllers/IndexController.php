...
class IndexController extends Controller
{
    ...
    public function actionCollege(){
        ...
        if($u_id==1){
            $xue=$connect->createCommand("select * from college");
        }else {
            //查询当前用户所在的学院及专业
            ...
            //print_r($jie);die;
            //学院
            $sql2 = "select c_name from user inner join college on user.college_id=college.c_id where user.college_id=" . $college_id;
            ...
            //echo $sql;die;
            $zhuan = $connect->createCommand($sql)->queryOne();
            //print_r($arr);die;
        }
        return $this->render('college',['xue'=>$xue,'zhuan'=>$zhuan,'jie'=>$jie]);
    }
